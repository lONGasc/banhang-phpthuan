                ...
                <div class="col-sm-6 text-left">
                  <div class="pages">
                    <ul class="pagination">
                      ...
                      <li class="active"><a href="index.php?controller=search&action=price&fromPrice=<?php echo $fromPrice; ?>&toPrice=<?php echo $toPrice; ?>&p=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                      <?php endfor; ?>
                    </ul>
                  </div>
          ...
          <!--   <div class="block product-price-range ">
              ...
              <div class="block-content">
                <div class="slider-range">
                  ...
                  <div class="amount-range-price">Range: $100 - $550</div>
